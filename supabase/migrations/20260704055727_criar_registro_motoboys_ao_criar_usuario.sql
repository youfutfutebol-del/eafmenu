...
begin
  ...
  -- Motoboy precisa também de um registro na tabela motoboys (veículo/disponibilidade),
  -- já que pedidos.motoboy_id referencia essa tabela, não usuarios diretamente.
