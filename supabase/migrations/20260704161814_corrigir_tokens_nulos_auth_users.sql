-- Corrige as contas já existentes com colunas de token NULL (causa dos erros 500 aleatórios no login)
...
-- Atualiza a função de criação pra sempre gravar string vazia nesses campos,
-- em vez de deixar NULL (que causa "Scan error ... converting NULL to string"
-- de forma imprevisível no login).
