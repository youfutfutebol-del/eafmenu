-- Corrige criações futuras: sempre grava o e-mail real da conta (mesmo o gerado
-- automaticamente), pra resolver_email_login sempre conseguir achar a conta pelo telefone.
...
begin
  ...
  -- Sempre grava o e-mail REAL da conta (mesmo o técnico/gerado), pra resolver_email_login
  -- sempre conseguir localizar a conta pelo telefone.
...
-- Corrige o registro do Eduardo (motoboy de teste) que ficou com email nulo
update usuarios set email = '21964386776@sememail.eafmenu.local'
where id = 'ed408106-b728-428c-9810-64547acc32cb' and email is null;
